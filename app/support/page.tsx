...
export default function Page() {
    return (
        <div className={styles.container}>
            ...
            <p>You may find our <a href='/terms' style={{ color: 'var(--primary)' }}>terms of service</a> and <a href='/privacy-policy' style={{ color: 'var(--primary)' }}>privacy policy</a> pages useful.</p>
        </div>
    );
}